...
public class NotificationBadge extends FrameLayout {
    ...
    private static final int DEFAULT_MAX_TEXT_LENGTH = 8;
    ...
    public NotificationBadge(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(R.layout.badge_profile, this, true);
    ...
    public void setType(Type type) {
        if (type == Type.XP)
            mIvBadgeBg.setImageResource(R.drawable.xp);
        else if (type == Type.SLI)
            mIvBadgeBg.setImageResource(R.drawable.sli);
    }
